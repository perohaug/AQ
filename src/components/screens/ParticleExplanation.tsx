...
function ParticleExplanation() {
  ...
  return (
    <div className="absolute left-1/2 transform translate-x-1/4 ml-40 mt-40">
      {/* First SVG */}
      ...
      <div className="ml-2 flex items-center justify-start mt-5" onClick={() => handleExpand('particle2')}>
        ...
        <p className="ml-2 font-medium text-m mr-1">De fleste partiklene trenger ned i lungene</p>
        {expanded.particle2 ? (
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="12" viewBox="0 0 22 12" fill="none">
            <path d="M20.829 1.00022L10.9629 10.704L1.00657 1.72343" stroke="black" />
          </svg>
      ...
      {expanded.particle2 && <p className="mt-2 text-sm ml-12">Vedfyring og eksos</p>}
      ...
      {expanded.particle3 && <p className="mt-2 text-sm ml-12">Veitrafikk</p>}
