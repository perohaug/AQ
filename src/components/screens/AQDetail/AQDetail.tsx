      ...
      <div className="bg-background relative">
        ...
        <div className="flex justify-center">
            ...
            {isViewMore && (
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 mt-20">
                <div className="flex items-center mt-80">
                  <button
                    className="absolute rounded-full bg-blue-800 text-white text-lg px-4 py-2 mb-20 hover:scale-110 transition-transform duration-300"
          ...
          {currentAQ != aqMessage['low'] && (
              <MainPollutants data={data} city={city} />
